...
function setView(view) {
  ...
  document
    .getElementById("syn-btn-modified")
    .classList.toggle("active", view === "modified");
  document
    .getElementById("syn-btn-raw")
    .classList.toggle("active", view === "raw");
...
function resetView() {
  ...
  document
    .querySelectorAll(".syn-list-item")
...
async function initSynergy() {
  ...
  try {
    ...
    document
      .getElementById("syn-btn-raw")
      .addEventListener("click", () => setView("raw"));
    document
      .getElementById("syn-btn-modified")
      .addEventListener("click", () => setView("modified"));
    document
      .getElementById("syn-btn-reset")
